...
public class Simulation {
	...
	public static void ReportGeneration() {
		...
		System.out.println("Report: Shipping Boxes Unlimited with 4 boxes per palet \n");
		...
		System.out.println("\n3.");
		System.out.println("The average number of departing boxes and monitor packed is: " + (double)(numDepartures*4)/100 + " which represents "+ (double)numDepartures/100 +" palets with 4 boxes and monitor per palets");
		System.out.println("Compares to the average number of departing boxes and monitor packed that is 26.1 if we don't put 4 boxes per palet (SimulationOnePerPalet)");
		
		System.out.println("\n4.");
		System.out.println("Over 100 days, employees would have to work late " + pretty.format(extraHoursDay) + " days with an average of " + pretty.format(sumExtraTime) + " minutes per days.");
