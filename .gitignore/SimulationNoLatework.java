...
public class SimulationNoLatework {
	...
	public static void shipping() {
		...
		if (palet == 4  && clock >= lastPaletDeparture) {
			
			shippingTime = (uniform(stream, 6.25, .75) + 2 + 1);
	...
	public static void ReportGeneration() {
		...
		System.out.println("Report: Shipping Boxes Unlimited with 4 boxes per palet and no late work \n");
		...
		System.out.println("The average of packed and shipped boxes and monitor are equal to: " + pretty.format((double)(numDepartures*4)/100) + " per day.");
		System.out.println("The average of shipped palets is equal to: " + pretty.format((double)numPalet/100) + " per day.");
		...
		System.out.println("\n3.");
		System.out.println("\nThe number of departing boxes and monitor packed is: " + numDepartures*4 + " which represents "+ numDepartures +" palets with 4 boxes and monitor per palets");
		
		System.out.println("\n4.");
		System.out.println("Over 100, employees would have to work late " + pretty.format(extraHoursDay) + " days with an average of " + pretty.format(sumExtraTime) + " minutesper days.");
		...
		System.out.println("As you can see in this simulation, if the employees do not start any task in the last 21 minutes they don't have any extra hours.");
